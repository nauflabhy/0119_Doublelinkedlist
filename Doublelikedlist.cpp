...
class DoubleLinkedList {
    ...
    public:
        ...
        void addNode(){
            ...
            // Step8 : Locate position for insertion
            Node *current = START;
            ...
            newNode->next = current->next; // Step9a : newNode.next = current.next
            newNode->prev = current;       // Step9b : newNode.prev = current

            // Insert last node
            if(current->next != NULL)
                current->next->prev = newNode; // Step9c : current.next.prev = newNode
            current->next = newNode; // Step9d : current.next = newNode
        }
